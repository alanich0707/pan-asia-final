...
import { User, Page, Announcement, LifeService, Language, Employer, MedicalRecord, Promotion } from './types';
import { MOCK_ANNOUNCEMENTS, LIFESTYLE_SERVICES, TRANSLATIONS, MOCK_WORKER_DATABASE, EMPLOYERS, MONTHLY_PROMOTIONS, BLOOD_TYPES } from './constants';
...
const App: React.FC = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    // Updated Admin Access Logic: ALAN / ICH
    if (cleanId === 'ALAN' && cleanPwd === 'ICH') {
      ...
      <div className="w-full max-w-sm z-20">
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 p-8 rounded-[2.5rem] shadow-2xl">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            {loginError && <div className="text-red-300 text-[11px] font-black text-center animate-bounce">{loginError}</div>}
